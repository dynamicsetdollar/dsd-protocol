...
describe('Upgradeable', function () {
    ...
    describe('set initial implementation', function () {
        ...
        it('sets implementation correctly', async function () {
            expect(await this.upgradeable.implementation()).to.be.equal(
                this.implA.address
            )
            expect(
                await this.upgradeable.isInitialized(this.implA.address)
            ).to.be.equal(true)
        })
    ...
    describe('upgrades after initial implementation', function () {
        ...
        it('sets implementation correctly', async function () {
            ...
            expect(
                await this.upgradeable.isInitialized(this.implB.address)
            ).to.be.equal(true)
        })
