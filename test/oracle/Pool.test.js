...
describe('Pool', function () {
    ...
    beforeEach(async function () {
        ...
        this.dollar = await MockToken.new('Dynamic Set Dollar', 'DSD', 18, {
            from: ownerAddress,
            gas: 8000000,
        })
    ...
    describe('frozen', function () {
        describe('starts as frozen', function () {
            it('mints new Dollar tokens', async function () {
                expect(
                    await this.pool.statusOf(userAddress)
        ...
        describe('when deposit', function () {
            ...
            it('updates users balances', async function () {
                expect(
                    await this.univ2.balanceOf(userAddress)
                ).to.be.bignumber.equal(new BN(0))
                expect(
                    await this.pool.balanceOfStaged(userAddress)
                ).to.be.bignumber.equal(new BN(1000))
                expect(
                    await this.pool.balanceOfBonded(userAddress)
                ).to.be.bignumber.equal(new BN(0))
            })
            ...
            it('updates dao balances', async function () {
                ...
                expect(await this.pool.totalBonded()).to.be.bignumber.equal(
                    new BN(0)
                )
                expect(await this.pool.totalStaged()).to.be.bignumber.equal(
                    new BN(1000)
                )
            })
        ...
        describe('when withdraw', function () {
            ...
            describe('too much', function () {
                ...
                it('reverts', async function () {
                    await expectRevert(
                        this.pool.withdraw(2000, { from: userAddress }),
        ...
        describe('when claim', function () {
            ...
            describe('simple', function () {
                ...
                it('updates users balances', async function () {
                    ...
                    expect(
                        await this.pool.balanceOfClaimable(userAddress)
                    ).to.be.bignumber.equal(new BN(0))
                    expect(
                        await this.pool.balanceOfRewarded(userAddress)
                    ).to.be.bignumber.equal(new BN(0))
                })
                ...
                it('updates dao balances', async function () {
                    ...
                    expect(
                        await this.pool.totalClaimable()
                    ).to.be.bignumber.equal(new BN(0))
                    expect(
                        await this.pool.totalRewarded()
                    ).to.be.bignumber.equal(new BN(0))
                })
            ...
            describe('too much', function () {
                ...
                it('reverts', async function () {
                    await expectRevert(
                        this.pool.claim(2000, { from: userAddress }),
            ...
            describe('no reward', function () {
                describe('simple', function () {
                    ...
                    it('updates dao balances', async function () {
                        ...
                        expect(
                            await this.pool.totalBonded()
                        ).to.be.bignumber.equal(new BN(1000))
                        expect(
                            await this.pool.totalStaged()
                        ).to.be.bignumber.equal(new BN(0))
                    })
                    ...
                    it('emits Bond event', async function () {
                        ...
                        expect(event.args.start).to.be.bignumber.equal(
                            new BN(2)
                        )
                ...
                describe('multiple', function () {
                    ...
                    it('updates dao balances', async function () {
                        expect(
                            await this.univ2.balanceOf(this.pool.address)
                        ).to.be.bignumber.equal(new BN(2800))
                        expect(
                            await this.pool.totalBonded()
                        ).to.be.bignumber.equal(new BN(1500))
                        expect(
                            await this.pool.totalStaged()
            ...
            describe('with reward', function () {
                ...
                describe('after bond', function () {
                    ...
                    it('is fluid until', async function () {
                        expect(
                            await this.pool.fluidUntil(userAddress)
                        ).to.be.bignumber.equal(new BN(13))
                    })
                ...
                describe('multiple with reward first', function () {
                    ...
                    it('updates users balances', async function () {
                        ...
                        expect(
                            await this.pool.balanceOfRewarded(userAddress1)
                        ).to.be.bignumber.equal(new BN(1599))
                        expect(
                            await this.pool.balanceOfPhantom(userAddress1)
                        ).to.be.bignumber.equal(new BN(0))
                        expect(
                            await this.pool.balanceOfRewarded(userAddress2)
                        ).to.be.bignumber.equal(new BN(400))
                        expect(
                            await this.pool.balanceOfPhantom(userAddress2)
                        ).to.be.bignumber.equal(new BN(666))
                        expect(
                            await this.pool.balanceOfRewarded(userAddress)
                        ).to.be.bignumber.equal(new BN(0))
                        expect(
                            await this.pool.balanceOfPhantom(userAddress)
                        ).to.be.bignumber.equal(new BN(1333))
                    })
                    ...
                    it('updates dao balances', async function () {
                        ...
                        expect(
                            await this.pool.totalPhantom()
                        ).to.be.bignumber.equal(new BN(1999))
                    })
            ...
            describe('without reward', function () {
                ...
                describe('simple', function () {
                    ...
                    it('emits Unbond event', async function () {
                        ...
                        expect(event.args.newClaimable).to.be.bignumber.equal(
                            new BN(0)
                        )
                    })
                })
            ...
            describe('with reward', function () {
                ...
                describe('multiple', function () {
                    ...
                    it('updates users balances', async function () {
                        ...
                        expect(
                            await this.pool.balanceOfClaimable(userAddress1)
                        ).to.be.bignumber.equal(new BN(0))
                        expect(
                            await this.pool.balanceOfRewarded(userAddress1)
                        ).to.be.bignumber.equal(new BN(300))
                        ...
                        expect(
                            await this.pool.balanceOfClaimable(userAddress2)
                        ).to.be.bignumber.equal(new BN(0))
                        expect(
                            await this.pool.balanceOfRewarded(userAddress2)
                        ).to.be.bignumber.equal(new BN(200))
                ...
                describe('potential subtraction underflow', function () {
                    ...
                    it('updates users balances', async function () {
                        ...
                        expect(
                            await this.pool.balanceOfClaimable(userAddress)
                        ).to.be.bignumber.equal(new BN(1476))
                        expect(
                            await this.pool.balanceOfRewarded(userAddress)
                        ).to.be.bignumber.equal(new BN(0))
                        expect(
                        ...
                        expect(
                            await this.pool.balanceOfRewarded(userAddress1)
                        ).to.be.bignumber.equal(new BN(286))
                        expect(
                            await this.pool.balanceOfPhantom(userAddress1)
                        ).to.be.bignumber.equal(
                            new BN(600).mul(INITIAL_STAKE_MULTIPLE).addn(600)
                        ...
                        expect(
                            await this.pool.balanceOfRewarded(userAddress2)
                        ).to.be.bignumber.equal(new BN(238))
                        expect(
                            await this.pool.balanceOfPhantom(userAddress2)
                        ).to.be.bignumber.equal(
                    ...
                    it('updates dao balances', async function () {
                        ...
                        expect(
                            await this.pool.totalRewarded()
                        ).to.be.bignumber.equal(new BN(524))
                        expect(
                            await this.pool.totalPhantom()
                        ).to.be.bignumber.equal(
        ...
        describe('when provide', function () {
            ...
            describe('not enough rewards', function () {
                it('reverts', async function () {
                    await expectRevert(
                        this.pool.provide(2000, { from: userAddress }),
                        'Pool: insufficient rewarded balance'
                    )
                })
            })

            describe('simple', function () {
                const phantomAfterLessReward = new BN(1000)
                    .mul(INITIAL_STAKE_MULTIPLE)
                    .addn(1000)
                const phantomAfterNewBonded = phantomAfterLessReward.add(
                    new BN(10).mul(INITIAL_STAKE_MULTIPLE).addn(10)
                )
                ...
                it('updates users balances', async function () {
                    ...
                    expect(
                        await this.pool.balanceOfBonded(userAddress)
                    ).to.be.bignumber.equal(new BN(1010))
                    expect(
                        await this.pool.balanceOfRewarded(userAddress)
                    ).to.be.bignumber.equal(new BN(0))
                    expect(
                        await this.pool.balanceOfPhantom(userAddress)
                    ).to.be.bignumber.equal(phantomAfterNewBonded)
                })
                ...
                it('emits Deposit event', async function () {
                    ...
                    expect(event.args.value).to.be.bignumber.equal(new BN(1000))
                    expect(event.args.lessUsdc).to.be.bignumber.equal(
                        new BN(1000)
                    )
                    expect(event.args.newUniv2).to.be.bignumber.equal(
                        new BN(10)
                    )
                })
            })
            ...
            describe('complex', function () {
                const phantomAfterLessReward = new BN(1000)
                    ...
                    .addn(1000)
                const phantomAfterNewBonded = phantomAfterLessReward.add(
                    new BN(10).mul(INITIAL_STAKE_MULTIPLE).addn(15)
                )
                const totalPhantom = phantomAfterNewBonded.add(
                    new BN(1000).mul(INITIAL_STAKE_MULTIPLE).addn(1000)
                )
                ...
                it('updates dao balances', async function () {
                    expect(
                        await this.univ2.balanceOf(this.pool.address)
                    ).to.be.bignumber.equal(new BN(2010))
                    expect(await this.pool.totalStaged()).to.be.bignumber.equal(
                        new BN(0)
                    )
                    expect(
                    ...
                    expect(
                        await this.pool.totalPhantom()
                    ).to.be.bignumber.equal(totalPhantom)
                })
    ...
    describe('fluid', function () {
        ...
        it('is fluid', async function () {
            expect(await this.pool.statusOf(userAddress)).to.be.bignumber.equal(
                FLUID
            )
        })
        ...
        describe('when deposit', function () {
            it('reverts', async function () {
                await expectRevert(
                    this.pool.deposit(1000, { from: userAddress }),
                    'Pool: Not frozen'
                )
            })
        })
        ...
        describe('when withdraw', function () {
            it('reverts', async function () {
                await expectRevert(
                    this.pool.withdraw(1000, { from: userAddress }),
                    'Pool: Not frozen'
                )
            })
        })
        ...
        describe('when claim', function () {
            it('reverts', async function () {
                await expectRevert(
                    this.pool.claim(1000, { from: userAddress }),
                    'Pool: Not frozen'
                )
            })
        })
        ...
        describe('when provide', function () {
            it('reverts', async function () {
                await expectRevert(
                    this.pool.provide(1000, { from: userAddress }),
                    'Pool: Not frozen'
                )
            })
        })
    ...
    describe('when pause', function () {
        ...
        describe('as dao', function () {
            ...
            it('reverts on deposit', async function () {
                await expectRevert(
                    this.pool.deposit(2000, { from: userAddress }),
                    'Paused'
                )
            })
            ...
            it('reverts on bond', async function () {
                await expectRevert(
                    this.pool.bond(2000, { from: userAddress }),
                    'Paused'
                )
            })
        ...
        describe('as not dao', function () {
            it('reverts', async function () {
                await expectRevert(
                    this.pool.emergencyPause({ from: userAddress }),
                    'Not dao'
                )
            })
        })
    ...
    describe('when emergency withdraw', function () {
        ...
        describe('as dao', function () {
            ...
            it('transfers funds to the dao', async function () {
                expect(
                    await this.univ2.balanceOf(mockDao)
                ).to.be.bignumber.equal(new BN(1000))
                expect(
                    await this.univ2.balanceOf(this.pool.address)
                ).to.be.bignumber.equal(new BN(0))
                expect(
                    await this.dollar.balanceOf(mockDao)
                ).to.be.bignumber.equal(new BN(1000))
                expect(
                    await this.dollar.balanceOf(this.pool.address)
                ).to.be.bignumber.equal(new BN(0))
