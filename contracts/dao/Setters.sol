...
contract Setters is State, Getters {
    ...
    function incrementBalanceOfCoupons(
        ...
        _state.accounts[account].coupons[epoch] = _state.accounts[account]
            .coupons[epoch]
            .add(amount);
        _state.epochs[epoch].coupons.outstanding = _state.epochs[epoch]
            .coupons
            .outstanding
            .add(amount);
    ...
    function decrementAllowanceCoupons(
        ...
        _state.accounts[owner].couponAllowances[spender] = _state.accounts[
            owner
        ]
    ...
    function incrementApproveFor(address candidate, uint256 amount) internal {
        _state.candidates[candidate].approve = _state.candidates[candidate]
            .approve
            .add(amount);
    }
    ...
    function incrementRejectFor(address candidate, uint256 amount) internal {
        _state.candidates[candidate].reject = _state.candidates[candidate]
            .reject
            .add(amount);
    }
